...
func (op *VertexOperation) AddDirectedEdge(to *Vertex) *Edge {
	e := edge{}
	edge := Edge{from: op.v, to: to, edge: &e, isDirected: Directed}
...
func (op *VertexOperation) AddEdge(to *Vertex) (*Edge, *Edge) {
	e := edge{}
	edge := Edge{from: op.v, to: to, edge: &e, isDirected: Undirected}
	op.v.edges = append(op.v.edges, edge)

	edge2 := Edge{from: to, to: op.v, edge: &e, isDirected: Undirected}
